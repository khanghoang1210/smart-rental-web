    ...
    <>
      <div className="flex justify-center p-8 w-[1300px] gap-10">
        ...
        <div className="w-[45%] bg-white rounded-lg border border-blue-95 p-6 mr-4">
          ...
          <div>
            <div
              className="bg-gray-90 px-5 py-2 rounded-lg mb-4"
              onClick={() => handleEditMode("fullName")}
            >
            ...
            <div
              className="bg-gray-90 px-5 py-2 rounded-lg mb-4"
              onClick={() => handleEditMode("phoneNumber")}
            >
            ...
            <div
              className="bg-gray-90 px-5 py-2 rounded-lg mb-4"
              onClick={() => handleEditMode("address")}
            >
            ...
            <div className="flex gap-4">
              ...
              <div className="w-1/2">
                <div
                  className="bg-gray-90 px-5 py-2 rounded-lg mb-4"
                  onClick={() => handleEditMode("birthYear")}
                >
        ...
        <div className="w-[58%] bg-white ">
          <div className=" border border-blue-95 rounded-lg p-6">
            ...
            <div>
              <div
                className="bg-gray-90 px-5 py-2 rounded-lg mb-6"
                onClick={() => handleEditMode("accountNumber")}
              >
                ...
                {editMode === "accountNumber" ? (
                  ...
                  <p className="font-semibold text-sm text-blue-40">
                    {" "}
                    {paymentInfo.accountNumber || "Chưa cập nhật"}
                  </p>
                )}
              </div>
              <div
                className="bg-gray-90 px-5 py-2 rounded-lg mb-6"
                onClick={() => handleEditMode("accountName")}
              >
                ...
                {editMode === "accountName" ? (
                  ...
                  <p className="font-semibold text-sm text-blue-40">
                    {" "}
                    {paymentInfo.accountName || "Chưa cập nhật"}
                  </p>
                )}
              </div>
              ...
              >
                ...
                <p className="font-semibold text-sm text-blue-40">
                  {paymentInfo.bank || "Chọn ngân hàng"}
                </p>
              </div>
            </div>
          </div>
